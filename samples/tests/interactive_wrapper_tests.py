...
from samples.tools.interactive_wrapper import ESX
from samples.tools.interactive_wrapper import get_all_vms_in_folder
from samples.tools.interactive_wrapper import VM
...
class VMTests(TestCase):
    ...
    def test_should_return_interface_when_one_matches(self):
        ...
        actual_matching_interface = \
            self.wrapped_vm.get_first_network_interface_matching(
                lambda n: n.name == "bar")
